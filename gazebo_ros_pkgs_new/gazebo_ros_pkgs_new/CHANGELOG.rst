^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
Changelog for package gazebo_ros_new_pkgs_new
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^

2.5.19 (2019-06-04)
-------------------
* Remove extra angle bracket (`#893 <https://github.com/ros-simulation/gazebo_ros_new_pkgs_new/issues/893>`_)
...
* Renamed meta package for gazebo_ros_new_pkgs_new
