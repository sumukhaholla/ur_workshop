...
public:
  ...
  void LoadPaths()
  {
    ...
    ros::package::getPlugins("gazebo_ros_new","gazebo_media_path",gazebo_media_paths);
    ...
    ros::package::getPlugins("gazebo_ros_new","plugin_path",plugin_paths);
    ...
    ros::package::getPlugins("gazebo_ros_new","gazebo_model_path",model_paths);
    ...
    std::string gazeborc = ros::package::getPath("gazebo_ros_new")+"/.do_not_use_gazeborc";
