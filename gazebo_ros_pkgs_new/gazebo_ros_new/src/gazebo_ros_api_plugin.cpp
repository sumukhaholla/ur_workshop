...
GazeboRosApiPlugin::~GazeboRosApiPlugin()
{
  ...
  // Disconnect slots
  load_gazebo_ros_new_api_plugin_event_.reset();
...
void GazeboRosApiPlugin::Load(int argc, char** argv)
{
  ...
  if (!ros::isInitialized())
    ...
    ROS_ERROR_NAMED("api_plugin", "Something other than this gazebo_ros_new_api plugin started ros::init(...), command line arguments may not be parsed properly.");
  ...
  load_gazebo_ros_new_api_plugin_event_ = gazebo::event::Events::ConnectWorldCreated(boost::bind(&GazeboRosApiPlugin::loadGazeboRosApiPlugin,this,_1));
...
void GazeboRosApiPlugin::advertiseServices()
{
  ...
  ros::AdvertiseServiceOptions spawn_sdf_model_aso =
    ros::AdvertiseServiceOptions::create<gazebo_msgs_new::SpawnModel>(
  ...
  ros::AdvertiseServiceOptions delete_aso =
    ros::AdvertiseServiceOptions::create<gazebo_msgs_new::DeleteModel>(
  ...
  ros::AdvertiseServiceOptions delete_light_aso =
    ros::AdvertiseServiceOptions::create<gazebo_msgs_new::DeleteLight>(
  ...
  ros::AdvertiseServiceOptions get_model_properties_aso =
    ros::AdvertiseServiceOptions::create<gazebo_msgs_new::GetModelProperties>(
  ...
  ros::AdvertiseServiceOptions get_model_state_aso =
    ros::AdvertiseServiceOptions::create<gazebo_msgs_new::GetModelState>(
  ...
  ros::AdvertiseServiceOptions get_world_properties_aso =
    ros::AdvertiseServiceOptions::create<gazebo_msgs_new::GetWorldProperties>(
  ...
  ros::AdvertiseServiceOptions get_joint_properties_aso =
    ros::AdvertiseServiceOptions::create<gazebo_msgs_new::GetJointProperties>(
  ...
  ros::AdvertiseServiceOptions get_link_properties_aso =
    ros::AdvertiseServiceOptions::create<gazebo_msgs_new::GetLinkProperties>(
  ...
  ros::AdvertiseServiceOptions get_link_state_aso =
    ros::AdvertiseServiceOptions::create<gazebo_msgs_new::GetLinkState>(
  ...
  ros::AdvertiseServiceOptions get_light_properties_aso =
    ros::AdvertiseServiceOptions::create<gazebo_msgs_new::GetLightProperties>(
  ...
  ros::AdvertiseServiceOptions set_light_properties_aso =
    ros::AdvertiseServiceOptions::create<gazebo_msgs_new::SetLightProperties>(
  ...
  ros::AdvertiseServiceOptions get_physics_properties_aso =
    ros::AdvertiseServiceOptions::create<gazebo_msgs_new::GetPhysicsProperties>(
  ...
  ros::AdvertiseOptions pub_link_states_ao =
    ros::AdvertiseOptions::create<gazebo_msgs_new::LinkStates>(
                                                           "link_states",10,
  ...
  ros::AdvertiseOptions pub_model_states_ao =
    ros::AdvertiseOptions::create<gazebo_msgs_new::ModelStates>(
                                                            "model_states",10,
  ...
  ros::AdvertiseServiceOptions set_link_properties_aso =
    ros::AdvertiseServiceOptions::create<gazebo_msgs_new::SetLinkProperties>(
  ...
  ros::AdvertiseServiceOptions set_physics_properties_aso =
    ros::AdvertiseServiceOptions::create<gazebo_msgs_new::SetPhysicsProperties>(
  ...
  ros::AdvertiseServiceOptions set_model_state_aso =
    ros::AdvertiseServiceOptions::create<gazebo_msgs_new::SetModelState>(
  ...
  ros::AdvertiseServiceOptions set_model_configuration_aso =
    ros::AdvertiseServiceOptions::create<gazebo_msgs_new::SetModelConfiguration>(
  ...
  ros::AdvertiseServiceOptions set_joint_properties_aso =
    ros::AdvertiseServiceOptions::create<gazebo_msgs_new::SetJointProperties>(
  ...
  ros::AdvertiseServiceOptions set_link_state_aso =
    ros::AdvertiseServiceOptions::create<gazebo_msgs_new::SetLinkState>(
  ...
  ros::SubscribeOptions link_state_so =
    ros::SubscribeOptions::create<gazebo_msgs_new::LinkState>(
                                                          "set_link_state",10,
  ...
  ros::SubscribeOptions model_state_so =
    ros::SubscribeOptions::create<gazebo_msgs_new::ModelState>(
                                                           "set_model_state",10,
  ...
  ros::AdvertiseServiceOptions apply_body_wrench_aso =
    ros::AdvertiseServiceOptions::create<gazebo_msgs_new::ApplyBodyWrench>(
  ...
  ros::AdvertiseServiceOptions apply_joint_effort_aso =
    ros::AdvertiseServiceOptions::create<gazebo_msgs_new::ApplyJointEffort>(
  ...
  ros::AdvertiseServiceOptions clear_joint_forces_aso =
    ros::AdvertiseServiceOptions::create<gazebo_msgs_new::JointRequest>(
  ...
  ros::AdvertiseServiceOptions clear_body_wrenches_aso =
    ros::AdvertiseServiceOptions::create<gazebo_msgs_new::BodyRequest>(
...
void GazeboRosApiPlugin::onLinkStatesDisconnect()
{
  ...
  if (pub_link_states_connection_count_ <= 0) // disconnect with no subscribers
  {
    ...
    if (pub_link_states_connection_count_ < 0) // should not be possible
      ROS_ERROR_NAMED("api_plugin", "One too mandy disconnect from pub_link_states_ in gazebo_ros_new.cpp? something weird");
  }
}
...
void GazeboRosApiPlugin::onModelStatesDisconnect()
{
  ...
  if (pub_model_states_connection_count_ <= 0) // disconnect with no subscribers
  {
    ...
    if (pub_model_states_connection_count_ < 0) // should not be possible
      ROS_ERROR_NAMED("api_plugin", "One too mandy disconnect from pub_model_states_ in gazebo_ros_new.cpp? something weird");
  }
}

bool GazeboRosApiPlugin::spawnURDFModel(gazebo_msgs_new::SpawnModel::Request &req,
                                        gazebo_msgs_new::SpawnModel::Response &res)
{
...
bool GazeboRosApiPlugin::spawnSDFModel(gazebo_msgs_new::SpawnModel::Request &req,
                                       gazebo_msgs_new::SpawnModel::Response &res)
{
...
bool GazeboRosApiPlugin::deleteModel(gazebo_msgs_new::DeleteModel::Request &req,
                                     gazebo_msgs_new::DeleteModel::Response &res)
{
...
bool GazeboRosApiPlugin::deleteLight(gazebo_msgs_new::DeleteLight::Request &req,
                                     gazebo_msgs_new::DeleteLight::Response &res)
{
#if GAZEBO_MAJOR_VERSION >= 8
...
bool GazeboRosApiPlugin::getModelState(gazebo_msgs_new::GetModelState::Request &req,
                                       gazebo_msgs_new::GetModelState::Response &res)
{
#if GAZEBO_MAJOR_VERSION >= 8
  gazebo::physics::ModelPtr model = world_->ModelByName(req.model_name);
...
bool GazeboRosApiPlugin::getModelProperties(gazebo_msgs_new::GetModelProperties::Request &req,
                                            gazebo_msgs_new::GetModelProperties::Response &res)
{
#if GAZEBO_MAJOR_VERSION >= 8
  gazebo::physics::ModelPtr model = world_->ModelByName(req.model_name);
#else
...
bool GazeboRosApiPlugin::getWorldProperties(gazebo_msgs_new::GetWorldProperties::Request &req,
                                            gazebo_msgs_new::GetWorldProperties::Response &res)
{
...
bool GazeboRosApiPlugin::getJointProperties(gazebo_msgs_new::GetJointProperties::Request &req,
                                            gazebo_msgs_new::GetJointProperties::Response &res)
{
...
bool GazeboRosApiPlugin::getLinkProperties(gazebo_msgs_new::GetLinkProperties::Request &req,
                                           gazebo_msgs_new::GetLinkProperties::Response &res)
{
#if GAZEBO_MAJOR_VERSION >= 8
...
bool GazeboRosApiPlugin::getLinkState(gazebo_msgs_new::GetLinkState::Request &req,
                                      gazebo_msgs_new::GetLinkState::Response &res)
{
#if GAZEBO_MAJOR_VERSION >= 8
  gazebo::physics::LinkPtr body = boost::dynamic_pointer_cast<gazebo::physics::Link>(world_->EntityByName(req.link_name));
  gazebo::physics::EntityPtr frame = world_->EntityByName(req.reference_frame);
...
bool GazeboRosApiPlugin::getLightProperties(gazebo_msgs_new::GetLightProperties::Request &req,
                                               gazebo_msgs_new::GetLightProperties::Response &res)
{
#if GAZEBO_MAJOR_VERSION >= 8
  gazebo::physics::LightPtr phy_light = world_->LightByName(req.light_name);
#else
...
bool GazeboRosApiPlugin::setLightProperties(gazebo_msgs_new::SetLightProperties::Request &req,
                                               gazebo_msgs_new::SetLightProperties::Response &res)
{
#if GAZEBO_MAJOR_VERSION >= 8
  gazebo::physics::LightPtr phy_light = world_->LightByName(req.light_name);
#else
...
bool GazeboRosApiPlugin::setLinkProperties(gazebo_msgs_new::SetLinkProperties::Request &req,
                                           gazebo_msgs_new::SetLinkProperties::Response &res)
{
#if GAZEBO_MAJOR_VERSION >= 8
  gazebo::physics::LinkPtr body = boost::dynamic_pointer_cast<gazebo::physics::Link>(world_->EntityByName(req.link_name));
#else
...
bool GazeboRosApiPlugin::setPhysicsProperties(gazebo_msgs_new::SetPhysicsProperties::Request &req,
                                              gazebo_msgs_new::SetPhysicsProperties::Response &res)
{
...
bool GazeboRosApiPlugin::getPhysicsProperties(gazebo_msgs_new::GetPhysicsProperties::Request &req,
                                              gazebo_msgs_new::GetPhysicsProperties::Response &res)
{
  // supported updates
#if GAZEBO_MAJOR_VERSION >= 8
  gazebo::physics::PhysicsEnginePtr pe = (world_->Physics());
...
bool GazeboRosApiPlugin::setJointProperties(gazebo_msgs_new::SetJointProperties::Request &req,
                                            gazebo_msgs_new::SetJointProperties::Response &res)
{
...
bool GazeboRosApiPlugin::setModelState(gazebo_msgs_new::SetModelState::Request &req,
                                       gazebo_msgs_new::SetModelState::Response &res)
{
...
void GazeboRosApiPlugin::updateModelState(const gazebo_msgs_new::ModelState::ConstPtr& model_state)
{
  gazebo_msgs_new::SetModelState::Response res;
  gazebo_msgs_new::SetModelState::Request req;
  req.model_state = *model_state;
  /*bool success =*/ setModelState(req,res);
}

bool GazeboRosApiPlugin::applyJointEffort(gazebo_msgs_new::ApplyJointEffort::Request &req,
                                          gazebo_msgs_new::ApplyJointEffort::Response &res)
{
  gazebo::physics::JointPtr joint;
#if GAZEBO_MAJOR_VERSION >= 8
  for (unsigned int i = 0; i < world_->ModelCount(); i ++)
...
bool GazeboRosApiPlugin::clearJointForces(gazebo_msgs_new::JointRequest::Request &req,
                                          gazebo_msgs_new::JointRequest::Response &res)
{
...
bool GazeboRosApiPlugin::clearBodyWrenches(gazebo_msgs_new::BodyRequest::Request &req,
                                           gazebo_msgs_new::BodyRequest::Response &res)
{
...
bool GazeboRosApiPlugin::setModelConfiguration(gazebo_msgs_new::SetModelConfiguration::Request &req,
                                               gazebo_msgs_new::SetModelConfiguration::Response &res)
{
...
bool GazeboRosApiPlugin::setLinkState(gazebo_msgs_new::SetLinkState::Request &req,
                                      gazebo_msgs_new::SetLinkState::Response &res)
{
#if GAZEBO_MAJOR_VERSION >= 8
...
void GazeboRosApiPlugin::updateLinkState(const gazebo_msgs_new::LinkState::ConstPtr& link_state)
{
  gazebo_msgs_new::SetLinkState::Request req;
  gazebo_msgs_new::SetLinkState::Response res;
...
bool GazeboRosApiPlugin::applyBodyWrench(gazebo_msgs_new::ApplyBodyWrench::Request &req,
                                         gazebo_msgs_new::ApplyBodyWrench::Response &res)
{
#if GAZEBO_MAJOR_VERSION >= 8
...
{
  gazebo_msgs_new::LinkStates link_states;
...
{
  gazebo_msgs_new::ModelStates model_states;
...
void GazeboRosApiPlugin::physicsReconfigureCallback(gazebo_ros_new::PhysicsConfig &config, uint32_t level)
{
  if (!physics_reconfigure_initialized_)
  {
    gazebo_msgs_new::GetPhysicsProperties srv;
  ...
  else
  {
    ...
    {
      // pause simulation if requested
      gazebo_msgs_new::SetPhysicsProperties srv;
...
{
  physics_reconfigure_set_client_ = nh_->serviceClient<gazebo_msgs_new::SetPhysicsProperties>("/gazebo/set_physics_properties");
  physics_reconfigure_get_client_ = nh_->serviceClient<gazebo_msgs_new::GetPhysicsProperties>("/gazebo/get_physics_properties");
  ...
  physics_reconfigure_srv_.reset(new dynamic_reconfigure::Server<gazebo_ros_new::PhysicsConfig>());
