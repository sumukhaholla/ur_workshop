...
#include "gazebo_msgs_new/JointRequest.h"
#include "gazebo_msgs_new/BodyRequest.h"

#include "gazebo_msgs_new/SpawnModel.h"
#include "gazebo_msgs_new/DeleteModel.h"
#include "gazebo_msgs_new/DeleteLight.h"

#include "gazebo_msgs_new/ApplyBodyWrench.h"

#include "gazebo_msgs_new/SetPhysicsProperties.h"
#include "gazebo_msgs_new/GetPhysicsProperties.h"

#include "gazebo_msgs_new/SetJointProperties.h"

#include "gazebo_msgs_new/GetWorldProperties.h"

#include "gazebo_msgs_new/GetModelProperties.h"
#include "gazebo_msgs_new/GetModelState.h"
#include "gazebo_msgs_new/SetModelState.h"

#include "gazebo_msgs_new/GetJointProperties.h"
#include "gazebo_msgs_new/ApplyJointEffort.h"

#include "gazebo_msgs_new/GetLinkProperties.h"
#include "gazebo_msgs_new/SetLinkProperties.h"
#include "gazebo_msgs_new/SetLinkState.h"
#include "gazebo_msgs_new/GetLinkState.h"

#include "gazebo_msgs_new/GetLightProperties.h"
#include "gazebo_msgs_new/SetLightProperties.h"

// Topics
#include "gazebo_msgs_new/ModelState.h"
#include "gazebo_msgs_new/LinkState.h"
#include "gazebo_msgs_new/ModelStates.h"
#include "gazebo_msgs_new/LinkStates.h"
...
#include <ros/ros.h>
#include <gazebo_msgs_new/SetModelConfiguration.h>
#include <boost/shared_ptr.hpp>

// For physics dynamics reconfigure
#include <dynamic_reconfigure/server.h>
#include <gazebo_ros_new/PhysicsConfig.h>
#include "gazebo_msgs_new/SetPhysicsProperties.h"
#include "gazebo_msgs_new/GetPhysicsProperties.h"
...
public:
  ...
  bool spawnURDFModel(gazebo_msgs_new::SpawnModel::Request &req,
  ...
  bool spawnSDFModel(gazebo_msgs_new::SpawnModel::Request &req,
                     gazebo_msgs_new::SpawnModel::Response &res);

  /// \brief delete model given name
  bool deleteModel(gazebo_msgs_new::DeleteModel::Request &req,gazebo_msgs_new::DeleteModel::Response &res);

  /// \brief delete a given light by name
  bool deleteLight(gazebo_msgs_new::DeleteLight::Request &req,gazebo_msgs_new::DeleteLight::Response &res);

  /// \brief
  bool getModelState(gazebo_msgs_new::GetModelState::Request &req,gazebo_msgs_new::GetModelState::Response &res);

  /// \brief
  bool getModelProperties(gazebo_msgs_new::GetModelProperties::Request &req,gazebo_msgs_new::GetModelProperties::Response &res);

  /// \brief
  bool getWorldProperties(gazebo_msgs_new::GetWorldProperties::Request &req,gazebo_msgs_new::GetWorldProperties::Response &res);

  /// \brief
  bool getJointProperties(gazebo_msgs_new::GetJointProperties::Request &req,gazebo_msgs_new::GetJointProperties::Response &res);

  /// \brief
  bool getLinkProperties(gazebo_msgs_new::GetLinkProperties::Request &req,gazebo_msgs_new::GetLinkProperties::Response &res);

  /// \brief
  bool getLinkState(gazebo_msgs_new::GetLinkState::Request &req,gazebo_msgs_new::GetLinkState::Response &res);

  /// \brief
  bool getLightProperties(gazebo_msgs_new::GetLightProperties::Request &req,gazebo_msgs_new::GetLightProperties::Response &res);

  /// \brief
  bool setLightProperties(gazebo_msgs_new::SetLightProperties::Request &req,gazebo_msgs_new::SetLightProperties::Response &res);

  /// \brief
  bool setLinkProperties(gazebo_msgs_new::SetLinkProperties::Request &req,gazebo_msgs_new::SetLinkProperties::Response &res);

  /// \brief
  bool setPhysicsProperties(gazebo_msgs_new::SetPhysicsProperties::Request &req,gazebo_msgs_new::SetPhysicsProperties::Response &res);

  /// \brief
  bool getPhysicsProperties(gazebo_msgs_new::GetPhysicsProperties::Request &req,gazebo_msgs_new::GetPhysicsProperties::Response &res);

  /// \brief
  bool setJointProperties(gazebo_msgs_new::SetJointProperties::Request &req,gazebo_msgs_new::SetJointProperties::Response &res);

  /// \brief
  bool setModelState(gazebo_msgs_new::SetModelState::Request &req,gazebo_msgs_new::SetModelState::Response &res);

  /// \brief
  void updateModelState(const gazebo_msgs_new::ModelState::ConstPtr& model_state);

  /// \brief
  bool applyJointEffort(gazebo_msgs_new::ApplyJointEffort::Request &req,gazebo_msgs_new::ApplyJointEffort::Response &res);
  ...
  /// \brief
  bool clearJointForces(gazebo_msgs_new::JointRequest::Request &req,gazebo_msgs_new::JointRequest::Response &res);
  bool clearJointForces(std::string joint_name);

  /// \brief
  bool clearBodyWrenches(gazebo_msgs_new::BodyRequest::Request &req,gazebo_msgs_new::BodyRequest::Response &res);
  bool clearBodyWrenches(std::string body_name);

  /// \brief
  bool setModelConfiguration(gazebo_msgs_new::SetModelConfiguration::Request &req,gazebo_msgs_new::SetModelConfiguration::Response &res);

  /// \brief
  bool setLinkState(gazebo_msgs_new::SetLinkState::Request &req,gazebo_msgs_new::SetLinkState::Response &res);

  /// \brief
  void updateLinkState(const gazebo_msgs_new::LinkState::ConstPtr& link_state);

  /// \brief
  bool applyBodyWrench(gazebo_msgs_new::ApplyBodyWrench::Request &req,gazebo_msgs_new::ApplyBodyWrench::Response &res);
...
private:
  ...
  void physicsReconfigureCallback(gazebo_ros_new::PhysicsConfig &config, uint32_t level);
  ...
  gazebo::event::ConnectionPtr load_gazebo_ros_new_api_plugin_event_;
  ...
  boost::shared_ptr< dynamic_reconfigure::Server<gazebo_ros_new::PhysicsConfig> > physics_reconfigure_srv_;
  dynamic_reconfigure::Server<gazebo_ros_new::PhysicsConfig>::CallbackType physics_reconfigure_callback_;
