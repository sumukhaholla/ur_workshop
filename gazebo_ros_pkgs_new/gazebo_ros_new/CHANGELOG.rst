^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
Changelog for package gazebo_ros_new
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^

2.5.19 (2019-06-04)
-------------------
* Add output arg to launch files, plus some small fixes (`#905 <https://github.com/ros-simulation/gazebo_ros_new_pkgs_new/issues/905>`_)
...
2.5.18 (2019-01-23)
-------------------
* Fix typo exist -> exists (`#833 <https://github.com/ros-simulation/gazebo_ros_new_pkgs_new/issues/833>`_)
* Fix issue `#198 <https://github.com/ros-simulation/gazebo_ros_new_pkgs_new/issues/198>`_ 
  (`#823 <https://github.com/ros-simulation/gazebo_ros_new_pkgs_new/issues/823>`_)
...
2.5.16 (2018-06-04)
-------------------
* Use generic SIGINT parameter in kill command for gazebo script (kinetic-devel) (`#723 <https://github.com/ros-simulation/gazebo_ros_new_pkgs_new/issues/723>`_)
  * Use generic SIGINT parameter in kill command for gazebo script
  * redirect to kill command to std_err
* strip comments from parsed urdf (`#695 <https://github.com/ros-simulation/gazebo_ros_new_pkgs_new/issues/695>`_)
...
* Merge pull request `#672 <https://github.com/ros-simulation/gazebo_ros_new_pkgs_new/issues/672>`_ from ros-simulation/gzclient_verbose
  Pass verbose argument to gzclient
* Merge pull request `#670 <https://github.com/ros-simulation/gazebo_ros_new_pkgs_new/issues/670>`_ from ros-simulation/add_ros_api_plugin_to_gzclient
  Load the libgazebo_ros_new_api_plugin when starting gzclient
* Pass verbose argument to gzclient
* Load the libgazebo_ros_new_api_plugin when starting gzclient so that the ROS event loop will turn over, which is required when you have a client-side Gazebo plugin that uses ROS.
...
* Fix for relative frame errors (`#605 <https://github.com/ros-simulation/gazebo_ros_new_pkgs_new/issues/605>`_)
...
* Prevents GAZEBO_MODEL_DATABASE_URI from being overwritten (`#644 <https://github.com/ros-simulation/gazebo_ros_new_pkgs_new/issues/644>`_)
...
* Fix gazebo8 warnings part 5: ignition math in gazebo_ros_new (`#635 <https://github.com/ros-simulation/gazebo_ros_new_pkgs_new/issues/635>`_)
...
* gazebo_ros_new: fix support for python3 (`#622 <https://github.com/ros-simulation/gazebo_ros_new_pkgs_new/issues/622>`_)
* gazebo_ros_new_api_plugin: improve plugin xml parsing (`#625 <https://github.com/ros-simulation/gazebo_ros_new_pkgs_new/issues/625>`_)
* Replace Events::Disconnect* with pointer reset (`#623 <https://github.com/ros-simulation/gazebo_ros_new_pkgs_new/issues/623>`_)
* Install spawn_model using catkin_install_python (`#621 <https://github.com/ros-simulation/gazebo_ros_new_pkgs_new/issues/621>`_)
* [gazebo_ros_new] don't overwrite parameter "use_sim_time" (`#606 <https://github.com/ros-simulation/gazebo_ros_new_pkgs_new/issues/606>`_)
...
2.5.13 (2017-06-24)
-------------------
* Quote arguments to echo in libcommon.sh (`#590 <https://github.com/ros-simulation/gazebo_ros_new_pkgs_new/issues/590>`_)
...
2.5.11 (2017-04-18)
-------------------
* Changed the spawn model methods to spawn also lights. (`#511 <https://github.com/ros-simulation/gazebo_ros_new_pkgs_new/issues/511>`_)
...
* Use correct logerr method (`#557 <https://github.com/ros-simulation/gazebo_ros_new_pkgs_new/issues/557>`_)
...
* Fix ROS remapping by reverting "Remove ROS remapping arguments from gazebo_ros_new launch scripts.
...
* Remove ROS remapping arguments from gazebo_ros_new launch scripts.
* Contributors: Jose Luis Rivero, Martin Pecka

2.5.2 (2016-02-25)
------------------
* merging from indigo-devel
* Merge pull request `#302 <https://github.com/ros-simulation/gazebo_ros_new_pkgs_new/issues/302>`_ from maxbader/jade-devel-GetModelState
...
2.4.7 (2014-12-15)
------------------
* temporary hack to **fix** the -J joint position option (issue `#93 <https://github.com/ros-simulation/gazebo_ros_new_pkgs_new/issues/93>`_), sleeping for 1 second to avoid race condition. this branch should only be used for debugging, merge only as a last resort.
* Fixing set model state method and test
* Extended the fix for `#246 <https://github.com/ros-simulation/gazebo_ros_new_pkgs_new/issues/246>`_ also to debug, gazebo, gzclient and perf scripts.
* Update Gazebo/ROS tutorial URL
* [gazebo_ros_new] Fix for `#246 <https://github.com/ros-simulation/gazebo_ros_new_pkgs_new/issues/246>`_
  Fixing issue `#246 <https://github.com/ros-simulation/gazebo_ros_new_pkgs_new/issues/246>`_ in gzserver.
...
2.4.6 (2014-09-01)
------------------
* Merge pull request `#232 <https://github.com/ros-simulation/gazebo_ros_new_pkgs_new/issues/232>`_ from ros-simulation/fix_get_physics_properties_non_ode
  Fix get physics properties non ode
* Merge pull request `#183 <https://github.com/ros-simulation/gazebo_ros_new_pkgs_new/issues/183>`_ from ros-simulation/issue_182
  Fix STL iterator errors, misc. cppcheck (`#182 <https://github.com/ros-simulation/gazebo_ros_new_pkgs_new/issues/182>`_)
...
------------------
* added osx support for gazebo start scripts
* Remove gazebo_ros_new dependency on gazebo_plugins_new
...
2.3.5 (2014-03-26)
------------------
* gazebo_ros_new: [less-than-minor] fix newlines
* gazebo_ros_new: remove assignment to self
...
* fix indentation
* Merge pull request `#142 <https://github.com/ros-simulation/gazebo_ros_new_pkgs_new/issues/142>`_ from hsu/hydro-devel
  fix issue `#38 <https://github.com/ros-simulation/gazebo_ros_new_pkgs_new/issues/38>`_, gui segfault on model deletion
* Merge pull request `#140 <https://github.com/ros-simulation/gazebo_ros_new_pkgs_new/issues/140>`_ from ``v4hn/spawn_model_sleep``
...
* fix issue `#38 <https://github.com/ros-simulation/gazebo_ros_new_pkgs_new/issues/38>`_, gui segfault on model deletion by removing an obsolete call to set selected object state to "normal".
* replace time.sleep by rospy.Rate.sleep
...
2.3.0 (2013-08-12)
------------------
* gazebo_ros_new: fixed missing dependency on TinyXML
...
2.1.5 (2013-07-18)
------------------
* gazebo_ros_new: fixed variable names in gazebo_ros_new_paths_plugin
...
* Cleaned up gazebo_ros_new_paths_plugin
* 2.1.1

2.1.1 (2013-07-10 19:11)
------------------------
* Merge branch 'hydro-devel' of github.com:ros-simulation/gazebo_ros_new_pkgs_new into hydro-devel
* Reduced number of debug msgs
* Fixed physics dynamic reconfigure namespace
* gazebo_ros_new_api_plugin: set `plugin_loaded_` flag to true in
  GazeboRosApiPlugin::Load() function
* Actually we need `__init__.py`
* Cleaning up code
* Moved gazebo_interface.py from gazebo/ folder to gazebo_ros_new/ folder
...
2.1.0 (2013-06-27)
------------------
* gazebo_ros_new: added deprecated warning for packages that use gazebo as
  package name for exported paths
* Hiding some debug info
* gazebo_ros_new: use rosrun in debug script, as rospack find gazebo_ros_new returns the wrong path in install space
* Hide Model XML debut output to console
* gazebo_ros_new_api_plugin.h is no longer exposed in the include folder
* Added args to launch files, documentation
* Merge pull request `#28 <https://github.com/ros-simulation/gazebo_ros_new_pkgs_new/issues/28>`_ from osrf/no_roscore_handling
  Better handling of gazebo_ros_new run when no roscore started
* gazebo_ros_new: also support gazebo instead of gazebo_ros_new as package name for plugin_path, gazebo_model_path or gazebo_media_path exports
...
* Added small comment
* adding install for gazebo_ros_new launchfiles
...
* Updated launch and world files and moved to gazebo_ros_new
