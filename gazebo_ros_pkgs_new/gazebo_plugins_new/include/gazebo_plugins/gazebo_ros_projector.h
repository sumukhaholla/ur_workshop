...
/** \defgroup GazeboRosProjector Plugin XML Reference and Example
  ...
  <projector name="projector_model">
    <body:empty name="projector_body_name">
     ...
      <controller:gazebo_ros_new_projector_controller name="projector_controller" plugin="libgazebo_ros_new_projector.so">
      ...
      </controller:gazebo_ros_new_projector_controller>
