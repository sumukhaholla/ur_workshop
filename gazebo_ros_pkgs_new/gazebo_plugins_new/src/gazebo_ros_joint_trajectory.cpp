...
// *************************************************************
// DEPRECATED
// This class has been renamed to gazebo_ros_new_joint_pose_trajectory
// *************************************************************
...
{
  ROS_WARN_NAMED("gazebo_ros_new_joint_trajectory","DEPRECATED: gazebo_ros_new_joint_trajectory has been renamed to gazebo_ros_new_joint_pose_trajectory");
  ...
  sdf::ElementPtr _sdf)
{
  ...
  else
  {
    gzerr << "Not loading plugin since ROS hasn't been "
          ...
          << "  gazebo -s libgazebo_ros_new_api_plugin.so\n";
  }
}
...
void GazeboRosJointTrajectory::LoadThread()
{
  ...
  if (this->service_name_ != "")
  {
    ros::AdvertiseServiceOptions srv_aso =
      ros::AdvertiseServiceOptions::create<gazebo_msgs_new::SetJointTrajectory>(
      this->service_name_,
...
bool GazeboRosJointTrajectory::SetTrajectory(
  const gazebo_msgs_new::SetJointTrajectory::Request& req,
  const gazebo_msgs_new::SetJointTrajectory::Response& res)
{
  boost::mutex::scoped_lock lock(this->update_mutex);
