...
{
  ROS_INFO_NAMED("vacuum_gripper", "Loading gazebo_ros_new_vacuum_gripper");
  ...
  if (!link_)
  {
    ...
    ROS_FATAL_NAMED("vacuum_gripper", "gazebo_ros_new_vacuum_gripper plugin error: link named: %s does not exist", link_name_.c_str());
    ROS_FATAL_NAMED("vacuum_gripper", "gazebo_ros_new_vacuum_gripper plugin error: You should check it exists and is not connected with fixed joint");
    ROS_FATAL_NAMED("vacuum_gripper", "gazebo_ros_new_vacuum_gripper plugin error: Found links are: %s", found.c_str());
    return;
  }
  ...
  ROS_INFO_NAMED("vacuum_gripper", "Loaded gazebo_ros_new_vacuum_gripper");
}
...
{
  if (status_) {
    ROS_WARN_NAMED("vacuum_gripper", "gazebo_ros_new_vacuum_gripper: already status is 'on'");
  } else {
    status_ = true;
    ROS_INFO_NAMED("vacuum_gripper", "gazebo_ros_new_vacuum_gripper: status: off -> on");
  }
  return true;
}
                                     ...
                                     std_srvs::Empty::Response &res)
{
  if (status_) {
    status_ = false;
    ROS_INFO_NAMED("vacuum_gripper", "gazebo_ros_new_vacuum_gripper: status: on -> off");
  } else {
    ROS_WARN_NAMED("vacuum_gripper", "gazebo_ros_new_vacuum_gripper: already status is 'off'");
  }
  return true;
}
