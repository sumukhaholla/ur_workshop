^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
Changelog for package gazebo_plugins_new
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^

2.5.19 (2019-06-04)
-------------------
* Accept 0 and 1 as booleans to support URDF to SDF boolean conversion; establish function parity with melodic (`#928 <https://github.com/ros-simulation/gazebo_ros_new_pkgs_new/issues/928>`_)
* Contributors: ampleh

2.5.18 (2019-01-23)
-------------------
* Corrected the typo 'ture' to 'true' (`#828 <https://github.com/ros-simulation/gazebo_ros_new_pkgs_new/issues/828>`_)
* Add horizontal movement option (`#814 <https://github.com/ros-simulation/gazebo_ros_new_pkgs_new/issues/814>`_)
  * add horizontal movement option
  * address pr comments
* Corrected depth camera plugin initialization (kinetic-devel)
  (`#750 <https://github.com/ros-simulation/gazebo_ros_new_pkgs_new/issues/750>`)
* Initialize depth_image_connect_count to 0
* Contributors: Daiki Maekawa, Jack Liu, Kevin Allen, Martin Ganeff, Veera Ragav

2.5.17 (2018-06-07)
-------------------
* gazebo_plugins_new: install triggered camera plugins (`#740 <https://github.com/ros-simulation/gazebo_ros_new_pkgs_new/issues/740>`_)
  Fixes `#739 <https://github.com/ros-simulation/gazebo_ros_new_pkgs_new/issues/739>`_.
* Contributors: Steven Peters

2.5.16 (2018-06-04)
-------------------
* Add publishOdomTF flag (`#692 <https://github.com/ros-simulation/gazebo_ros_new_pkgs_new/issues/692>`_) (`#716 <https://github.com/ros-simulation/gazebo_ros_new_pkgs_new/issues/716>`_)
* ROS UTILS: prevent segfault when using alternative GazeboRos constructor (kinetic-devel) (`#721 <https://github.com/ros-simulation/gazebo_ros_new_pkgs_new/issues/721>`_)
* Triggered camera / multicamera plugins (`#687 <https://github.com/ros-simulation/gazebo_ros_new_pkgs_new/issues/687>`_)
* Fix sensors after time reset (`#683 <https://github.com/ros-simulation/gazebo_ros_new_pkgs_new/issues/683>`_)
...
* Support 16-bit cameras (`#675 <https://github.com/ros-simulation/gazebo_ros_new_pkgs_new/issues/675>`_)
...
* gazebo_plugins_new: unique names for distortion tests (`#685 <https://github.com/ros-simulation/gazebo_ros_new_pkgs_new/issues/685>`_)
* Fix tests and compiler warnings on kinetic-devel `#678 <https://github.com/ros-simulation/gazebo_ros_new_pkgs_new/issues/678>`_
* fix gazebo9 warnings by removing Set.*Accel calls
* gazebo_plugins_new: don't use -r in tests
* Contributors: Jose Luis Rivero, Julian Kooij, Kevin Allen, Martin Günther, Steven Peters, krzysztof-zurad

2.5.15 (2018-02-12)
-------------------
* Merge pull request `#669 <https://github.com/ros-simulation/gazebo_ros_new_pkgs_new/issues/669>`_ from ahcorde/kinetic-devel
...
* Fix gazebo8 warnings part 10: ifdefs for GetModel, GetEntity, Light (`#656 <https://github.com/ros-simulation/gazebo_ros_new_pkgs_new/issues/656>`_)
* gazebo8 warnings: ifdefs for Get.*Vel() (`#653 <https://github.com/ros-simulation/gazebo_ros_new_pkgs_new/issues/653>`_)
* Fix gazebo8 warnings part 8: ifdef's for GetWorldPose (`#650 <https://github.com/ros-simulation/gazebo_ros_new_pkgs_new/issues/650>`_)
...
2.5.14 (2017-12-11)
-------------------
* for gazebo8+, call functions without Get (`#639 <https://github.com/ros-simulation/gazebo_ros_new_pkgs_new/issues/639>`_)
* Fix gazebo8 warnings part 4: convert remaining local variables in plugins to ign-math (`#633 <https://github.com/ros-simulation/gazebo_ros_new_pkgs_new/issues/633>`_)
* Fix gazebo8 warnings part 3: more ign-math in plugins (`#631 <https://github.com/ros-simulation/gazebo_ros_new_pkgs_new/issues/631>`_)
* Fix gazebo8 warnings part 2: replace private member gazebo::math types with ignition (`#628 <https://github.com/ros-simulation/gazebo_ros_new_pkgs_new/issues/628>`_)
* Replace Events::Disconnect* with pointer reset (`#623 <https://github.com/ros-simulation/gazebo_ros_new_pkgs_new/issues/623>`_)
* Merge pull request `#542 <https://github.com/ros-simulation/gazebo_ros_new_pkgs_new/issues/542>`_ from davetcoleman/kinetic-gazebo7-only
  Remove compiler directive flags for < GAZEBO 7
* Contributors: Dave Coleman, Steven Peters

2.5.13 (2017-06-24)
-------------------
* Fix inverted height in block laser plugin (`#582 <https://github.com/ros-simulation/gazebo_ros_new_pkgs_new/issues/582>`_)
* Allow disabling distorted camera border crop (and associated tests) (`#572 <https://github.com/ros-simulation/gazebo_ros_new_pkgs_new/issues/572>`_)
* Add an IMU sensor plugin that inherits from SensorPlugin (`#363 <https://github.com/ros-simulation/gazebo_ros_new_pkgs_new/issues/363>`_)
...
2.5.12 (2017-04-25)
-------------------
* Revert catkin warning fix (`#567 <https://github.com/ros-simulation/gazebo_ros_new_pkgs_new/issues/567>`_)
...
* Fix: add gazebo_ros_new_range to catkin package libraries (`#558 <https://github.com/ros-simulation/gazebo_ros_new_pkgs_new/issues/558>`_)
...
* Fix destructor of GazeboRosVideo (`#547 <https://github.com/ros-simulation/gazebo_ros_new_pkgs_new/issues/547>`_)
* Less exciting console output (`#549 <https://github.com/ros-simulation/gazebo_ros_new_pkgs_new/issues/549>`_)
* Fix SDF namespacing for Video Plugin (`#546 <https://github.com/ros-simulation/gazebo_ros_new_pkgs_new/issues/546>`_)
...
* Adding depth camera world to use in test to make depth camera have right timestamp `#408 <https://github.com/ros-simulation/gazebo_ros_new_pkgs_new/issues/408>`_- appears to be working (though only looking at horizon) but getting these sdf errors:
* `#408 <https://github.com/ros-simulation/gazebo_ros_new_pkgs_new/issues/408>`_ Make the multi camera timestamps current rather than outdated, also reuse the same update code
* Fix merge with kinetic branch
* `#408 <https://github.com/ros-simulation/gazebo_ros_new_pkgs_new/issues/408>`_ Making a test for multicamra that shows the timestamps are currently outdated, will fix them similar to how the regular camera was fixed.
* Fix for issue `#408 <https://github.com/ros-simulation/gazebo_ros_new_pkgs_new/issues/408>`_. The last measurement time is the time that gazebo generated the sensor data, so ought to be used. updateRate doesn't seem that useful.
...
* Accept /world for the frameName parameter in gazebo_ros_new_p3d
* Upgrade to gazebo 7 and remove deprecated driver_base dependency
  * Upgrade to gazebo 7 and remove deprecated driver_base dependency
  * disable gazebo_ros_new_control until dependencies are met
...
* Merge pull request `#368 <https://github.com/ros-simulation/gazebo_ros_new_pkgs_new/issues/368>`_ from l0g1x/jade-devel
  Covariance for published twist in skid steer plugin
* gazebo_ros_new_utils.h: include gazebo_config.h
...
* Add missing boost header
  ...
  and gazebo_ros_new_joint_state_publisher.cpp was using it
  implicitly.
...
* 2.4.9
* Generate changelog
* Merge pull request `#335 <https://github.com/ros-simulation/gazebo_ros_new_pkgs_new/issues/335>`_ from pal-robotics-forks/add_range_sensor_plugin
...
* [gazebo_ros_new_diff_drive] force call SetMaxForce since this Joint::Reset in gazebo/physics/Joint.cc reset MaxForce to zero and ModelPlugin::Reset is called after Joint::Reset
...
* change header to use opencv2/opencv.hpp issue `#274 <https://github.com/ros-simulation/gazebo_ros_new_pkgs_new/issues/274>`_
* Update Gazebo/ROS tutorial URL
* Merge pull request `#237 <https://github.com/ros-simulation/gazebo_ros_new_pkgs_new/issues/237>`_ from ros-simulation/update_header_license
  Update header license for Indigo
* Contributors: John Hsu, Jose Luis Rivero, Robert Codd-Downey, Tom Moore, hsu

2.4.6 (2014-09-01)
------------------
* Update gazebo_ros_new_openni_kinect.cpp
* merging from hydro-devel into indigo-devel
* Merge pull request `#204 <https://github.com/ros-simulation/gazebo_ros_new_pkgs_new/issues/204>`_ from fsuarez6/hydro-devel
  gazebo_plugins_new: Adding ForceTorqueSensor Plugin
* Updated to Apache 2.0 license
* Merge pull request `#180 <https://github.com/ros-simulation/gazebo_ros_new_pkgs_new/issues/180>`_ from vrabaud/indigo-devel
...
* gazebo_plugin: Added updateRate parameter to the gazebo_ros_new_imu plugin
* gazebo_plugins_new: Adding ForceTorqueSensor Plugin
* remove PCL dependency
...
* gazebo_ros_new_diff_drive gazebo_ros_new_tricycle_drive encoderSource option names updated
* gazebo_ros_new_diff_drive is now able to use the wheels rotation of the optometry or the gazebo ground truth based on the 'odometrySource' parameter
...
* gazebo_ros_new_diff_drive was enhanced to publish the wheels tf or the wheels joint state depending on two additinal xml options <publishWheelTF> <publishWheelJointState>
...
2.4.3 (2014-05-12)
------------------
* gazebo_plugins_new: add run-time dependency on gazebo_ros_new
* Merge pull request `#176 <https://github.com/ros-simulation/gazebo_ros_new_pkgs_new/issues/176>`_ from ros-simulation/issue_175
  Fix `#175 <https://github.com/ros-simulation/gazebo_ros_new_pkgs_new/issues/175>`_: dynamic reconfigure dependency error
* Remove unneeded dependency on pcl_ros
* Fix `#175 <https://github.com/ros-simulation/gazebo_ros_new_pkgs_new/issues/175>`_: dynamic reconfigure dependency error
* Contributors: Steven Peters
...
* multicamera bad namespace. Fixes `#161 <https://github.com/ros-simulation/gazebo_ros_new_pkgs_new/issues/161>`_
...
* Use function for accessing scene node in gazebo_ros_new_video
...
* Simplify ``gazebo_plugins_new/CMakeLists.txt``
...
2.3.3 (2013-10-10)
------------------
* gazebo_plugins_new: use shared pointers for variables shared among cameras
  It is not allowed to construct a shared_ptr from a pointer to a member
  variable.
* gazebo_plugins_new: moved initialization of shared_ptr members of
  GazeboRosCameraUtils to `GazeboRosCameraUtils::Load()`
  This fixes segfaults in gazebo_ros_new_depth_camera and
  gazebo_ros_new_openni_kinect as the pointers have not been initialized
  there.
...
* Merge branch 'hydro-devel' of `gazebo_ros_new_pkgs_new <github.com:ros-simulation/gazebo_ros_new_pkgs_new>`_ into synchronize_with_drcsim_plugins
...
* gazebo_plugins_new: replace deprecated boost function
...
* gazebo_plugins_new: fix linkedit issues
  Note: other linkedit errors were fixed upstream
  in gazebo
* gazebo_ros_new_openni_kinect plugin: adds publishing of the camera info
  again (fixes `#95 <https://github.com/ros-simulation/gazebo_ros_new_pkgs_new/issues/95>`_)
* Merge pull request `#90 <https://github.com/ros-simulation/gazebo_ros_new_pkgs_new/issues/90>`_ from piyushk/add_model_controller
...
* ROS Video Plugin for Gazebo - allows displaying an image stream in an OGRE texture inside gazebo. Also provides a fix for `#85 <https://github.com/ros-simulation/gazebo_ros_new_pkgs_new/issues/85>`_.
* patch a fix for prosilica plugin (startup race condition where `rosnode_` might still be NULL).
* Added explanation of new dependency in gazebo_ros_new_pkgs_new
* switch Prosilica camera from type depth to regular camera (as depth data were not used).
* migrating prosilica plugin from pr2_gazebo_plugins_new
...
2.1.3 (2013-07-13)
------------------
* temporarily add tbb as a work around for `#74 <https://github.com/ros-simulation/gazebo_ros_new_pkgs_new/issues/74>`_
...
* Merge pull request `#59 <https://github.com/ros-simulation/gazebo_ros_new_pkgs_new/issues/59>`_ from ros-simulation/CMake_Tweak
...
2.1.0 (2013-06-27)
------------------
* gazebo_plugins_new: always use gazebo/ path prefix in include directives
* gazebo_plugins_new: call Advertise() directly after initialization has
  completed in gazebo_ros_new_openni_kinect and gazebo_ros_new_depth_camera
  plugins, as the sensor will never be activated otherwise
* Merge pull request `#41 <https://github.com/ros-simulation/gazebo_ros_new_pkgs_new/issues/41>`_ from ZdenekM/hydro-devel
  Added skid steering plugin (modified diff drive plugin).
* Merge pull request `#35 <https://github.com/ros-simulation/gazebo_ros_new_pkgs_new/issues/35>`_ from meyerj/fix_include_directory_installation_target
  Header files of packages gazebo_ros_new and gazebo_plugins_new are installed to the wrong location
* Rotation fixed.
* Skid steering drive plugin.
* gazebo_plugins_new: added missing initialization of `GazeboRosDepthCamera::advertised_`
* gazebo_plugins_new: fixed depth and openni kinect camera plugin segfaults
* gazebo_plugins_new: terminate the service thread properly on destruction of a PubMutliQueue object without shuting down ros
* gazebo_plugins_new/gazebo_ros_new: fixed install directories for include files and gazebo scripts
...
* Combining Atlas code with old gazebo_plugins_new
* Combining Atlas code with old gazebo_plugins_new
...
* Fixed deprecated function calls in gazebo_plugins_new
